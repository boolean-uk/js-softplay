...
let adults = 0
let children = 0
const peopleInside = {adults: 0, children: 0}
...
// If any of these checks fail, the function should return false. Otherwise, the function should return true and numAdults and numChildren should 
// be added to the current totals.
...
const enter = (numAdults, numChildren) => {
  if (numChildren > numAdults){
    ...
    peopleInside.adults += numAdults
    peopleInside.children += numChildren
    return true
  }
}
